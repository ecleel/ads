...
module Ads
  class AdsController < ApplicationController
    ...
    def create
      ...
      if @ad.save
        redirect_to [@campaign, @ad], notice: 'Ad was successfully created.'
      else
        render action: 'new'
      end
    end
    ...
    def update
      if @ad.update(ad_params)
        redirect_to [@campaign, @ad], notice: 'Ad was successfully updated.'
      else
        render action: 'edit'
      end
    end
    ...
    def destroy
      @ad.destroy
      redirect_to campaign_url(@campaign), notice: 'Ad was successfully destroyed.'
    end
